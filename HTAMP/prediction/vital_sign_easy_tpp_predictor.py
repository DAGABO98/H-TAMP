...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="VitalSignEasyTPPPredictor",
        description="Train an EasyTPP vital-sign request model from a JSON config file.",
    )
    parser.add_argument(
        "--config_path",
        type=str,
...
def main() -> int:
    ...
    try:
        ...
        predictor = VitalSignEasyTPPPredictor()
