...
from HTAMP.prediction.point_process_models.easyTPP.torch_baselayer import ScaledSoftplus
from HTAMP.prediction.point_process_models.easyTPP.torch_basemodel import TorchBaseModel
from HTAMP.prediction.point_process_models.easyTPP.ssm.models import LLH, Int_Backward_LLH, Int_Forward_LLH
...
class S2P2(TorchBaseModel):
    ...
    def _get_intensity(
        self, x_LP: Union[torch.tensor, List[torch.tensor]], right_us_BNH: List[torch.tensor]
    ) -> torch.Tensor:
        """
