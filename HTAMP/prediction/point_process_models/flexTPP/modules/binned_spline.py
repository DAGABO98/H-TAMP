"Code based on: https://github.com/vislearn/FrEIA/blob/master/FrEIA/modules/splines/binned.py"
...
from HTAMP.prediction.point_process_models.flexTPP.modules.base import InvertibleModule
from HTAMP.prediction.point_process_models.flexTPP.modules import utils
