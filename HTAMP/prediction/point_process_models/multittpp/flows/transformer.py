...
from HTAMP.prediction.point_process_models.multittpp.config import Config
from HTAMP.prediction.point_process_models.multittpp.flows.base import FlowReturnType
from HTAMP.prediction.point_process_models.multittpp.flows.spline import Spline
from HTAMP.prediction.point_process_models.multittpp.flows.utils import (
    new_gelu,
    LayerNorm,
)
...
class PositionEmbedding(nn.Module):
    ...
    def _build_embedding(self, n_events: int, n_embd: int, device: Optional[torch.device] = None):
