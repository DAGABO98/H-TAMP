...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_path", type=str, default="maps/hospital_floor/floor_top_view.png", help="Path to the input image")
    ...
    parser.add_argument("--map_path", type=str, default="maps/hospital_floor/occupancy_map.npy", help="Path to save the occupancy map")
